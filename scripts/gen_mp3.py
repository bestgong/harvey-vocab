...
PHRASES = [
    ...
    "lights out",
    "dream of",
    # Oliver (2026-08-20): 汪培珽 L1-9 多词短语
    ...
    "make a mistake",
    "of course",
    # Danny and the Dinosaur (2026-08-27): 汪培珽 L1-10 多词短语
    "play with",
    "It would be nice to",
    "for a ride",
    "get on",
    ...
    "wake me up",
    "fell asleep",
    # The Magic Pear Tree (2026-09-10): 第二套图书馆 L3-1 多词短语
    "kind woman",
    "a little bit of",
    "golden pears",
    "too many",
    ...
    "next time",
    "less selfish",
    # The Boy Who Cried Wolf (2026-09-14): 第二套图书馆 L3-2 多词短语
    "This story is about",
    "from to",
    "grassy meadow",
    ...
    "bake the bread",
    "jump up",
    # The Musicians of Bremen (2026-09-24): 第二套图书馆 L3-4 多词短语
    "mean man",
    "come on",
    "for lunch",
    "get too old",
